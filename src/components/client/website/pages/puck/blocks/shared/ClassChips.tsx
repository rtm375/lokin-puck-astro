    ...
    <div className="flex flex-col gap-2">
      <div className="flex flex-wrap gap-1.5 items-center">
        <div
          ...
          className={`flex items-center px-2.5 h-7 rounded-full text-[11px] font-bold cursor-pointer transition-all border ${
            activeClassId === null 
        ...
        {appliedClasses.map((c: any) => (
          <div
            ...
            className={`flex items-center gap-1.5 px-2.5 h-7 rounded-full text-[11px] font-semibold cursor-pointer transition-all border ${
              activeClassId === c.id 
