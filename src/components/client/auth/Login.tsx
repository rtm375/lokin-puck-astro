...
const ALLOWED_MESSAGES = {
  check_email_confirmation: "auth.messages.check_email",
  access_denied: "auth.messages.access_denied",
  otp_expired: "auth.messages.otp_expired",
} as const;
...
export default function Login() {
  ...
  useEffect(() => {
    ...
    if (msgKey && msgKey in ALLOWED_MESSAGES) {
      setGlobalMessage(t(ALLOWED_MESSAGES[msgKey as AllowedMessageKey]));
    }

    if (errKey && errKey in ALLOWED_MESSAGES) {
      setGlobalError(t(ALLOWED_MESSAGES[errKey as AllowedMessageKey]));
    }
