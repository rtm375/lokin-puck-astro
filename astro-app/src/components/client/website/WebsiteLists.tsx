      ...
      <div className="py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <button
            ...
            className="flex flex-col items-center justify-center cursor-pointer h-full rounded-lg border-2 border-dashed border-gray-300 p-12 hover:border-gray-400 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
          >
            <svg
